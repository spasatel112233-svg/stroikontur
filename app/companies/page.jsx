...
const companies = [
  { title: 'ФасадСтрой', text: 'Фасады, утепление, реставрация, выездные объекты и сопровождение полного цикла работ с подготовкой, исполнением и закрытием этапов.', meta: 'Россия · СНГ · 12 лет на рынке' },
  { title: 'Инженерные решения', text: 'Внутренние сети, автоматика, вентиляция, щитовое оборудование и пусконаладка с опытом по промышленным и коммерческим объектам.', meta: 'Казахстан · Узбекистан · Промышленные объекты' },
  { title: 'БетонПроф', text: 'Монолит, бетонные работы, армирование, опалубка и субподрядные механизированные этапы с возможностью быстро усилить объект людьми и техникой.', meta: 'Россия · Турция · Команда 60+' }
];
    ...
    <main className="page">
      <div className="container">
        <PageHero
          tag="Компании"
          title="Компании"
          text="Профили подрядных и сервисных компаний с направлениями работ, регионами, опытом, кейсами и контактами для входящих запросов и делового отбора."
          visual="company"
