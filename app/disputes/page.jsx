...
const cases = [
  ['Не оплачены выполненные работы', 'Материалы и шаблоны для работы с просрочкой оплаты, претензиями и фиксацией позиции, когда деньги зависли и заказчик уходит от расчёта.'],
  ['Не подписывают акты', 'Комплект документов и действий, если заказчик затягивает подписание КС-2, КС-3 или акта приёмки и постоянно переносит решение вопроса.'],
  ['Уклоняются от приёмки', 'Формы уведомлений и порядок фиксации передачи результата заказчику, чтобы не остаться без доказательств по срокам и объёму.'],
  ['Спор по объёму или качеству', 'Подход к оформлению доказательств и подготовке документов по спорной ситуации, когда нужно защитить объём, качество и факт выполнения работ.']
];
