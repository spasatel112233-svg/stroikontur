...
const docs = [
  ['Акт выполненных работ', 'Готовая форма для фиксации факта выполнения работ, стоимости этапа и подтверждения передачи результата заказчику.'],
  ['КС-2', 'Готовая форма для строительных этапов, объёмов и подтверждения выполненных работ с более уверенной подачей под объектные сценарии.'],
  ['КС-3', 'Форма для взаиморасчётов по строительным этапам, закрытия объёмов и сопровождения договорных отношений.'],
  ['Претензия по оплате', 'Шаблон для работы с просрочкой оплаты, фиксацией позиции и подготовкой делового давления в рамках спора.'],
  ['Договор подряда', 'Базовый договор под выполнение строительных работ и услуг с ключевыми блоками по срокам, оплате и ответственности сторон.'],
  ['Уведомление о сдаче работ', 'Документ для фиксации передачи результата, уведомления заказчика и защиты позиции при затягивании приёмки.']
];
