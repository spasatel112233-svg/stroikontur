    ...
    <main className="page">
      <div className="container">
        <PageHero
          ...
          text="Размещайте и находите заказы, подряды, субподряды, коммерческие объекты, работы по благоустройству, поставкам, аренде техники и обслуживанию территорий. Сетка и карточки собраны плотнее, чтобы интерфейс выглядел деловым, а не пустым."
          visual="machinery"
          actions={
            <>
        ...
        <section className="section section-soft">
          <FilterBar
            ...
            selects={['Страна', 'Город / регион', 'Категория', 'Бюджет', 'Сроки']}
          />
