export default function RequestPage() {
  return (
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="mx-auto max-w-2xl px-6 py-10 md:px-10 lg:px-12">
        <div className="mb-8">
...
<option>Подрядчика</option>
            ...
            <div className="pt-2">
              <button
                type="submit"
                className="w-full rounded-xl bg-orange-500 px-5 py-3 text-sm font-semibold text-white transition hover:bg-orange-400 md:w-auto"
              >
                Отправить заявку
              </button>
            </div>
