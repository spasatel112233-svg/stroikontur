    ...
    <footer className="site-footer">
      <div className="container footer-grid">
        <div>
          ...
          <p className="footer-text">Платформа для заказов, подрядов, специалистов, компаний, документов и спорных ситуаций в строительстве.</p>
        </div>
        <div>
        ...
        <div>
          ...
          <div className="footer-links">
            ...
            <Link href="/request">Поддержка</Link>
          </div>
        </div>
      </div>
